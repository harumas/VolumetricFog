...
Online Documentation: https://inabstudios.gitbook.io/easy-outline-shader/
...
Masked Outlines:
In order to use this feature, you need to replace your old materials with new ones: OutlineMaskMetallic or OutlineMaskSpecular. After that you need to add OnlyOutlineWithMask shader to your object either by using OutlineDrawer script or as a second material. Set the stencil reference to 3.
URP:
There is three ways to use the outline shaders:
Add OnlyOutline shader as second material to your object.
