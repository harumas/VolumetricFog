half4 calSketchShading(half4 grayScaleCol, int useStroke, int useGradation, half strokeDensity, sampler2D paperTex,
                       sampler2D stroke1, sampler2D stroke2, float2 uv, float2 worldPos)
{
    if (!useStroke)
    {
