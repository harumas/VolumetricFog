    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes IN)
            {
                ...
                OUT.screenPos = ComputeScreenPos(OUT.positionHCS); // これだけ！
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                float NdotL = lerp(0.6, 1.0, step(0.5, saturate(n)  + 0.3));
                ...
                if (n< 0.3)
                {
                    hatchColor = SAMPLE_TEXTURE2D(_Hatch1, sampler_Hatch1, screenPos * _Hatch1_ST.xy + _Hatch1_ST.zw);
                }
